...
public class JSONFileItemReaderDemo {
    ...
    private ItemReader<TestData> jsonItemReader(){
        ...
        JacksonJsonObjectReader<TestData> jsonObjectReader = new JacksonJsonObjectReader<>(TestData.class);
        JsonItemReader<TestData> reader = new JsonItemReader<>(resource,jsonObjectReader);
